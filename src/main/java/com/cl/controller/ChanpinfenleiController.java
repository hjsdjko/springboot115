...
import com.cl.service.ChanpinfenleiService;
...
public class ChanpinfenleiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		chanpinfenlei = chanpinfenleiService.selectView(new EntityWrapper<ChanpinfenleiEntity>().eq("id", id));
    ...
    public R save(@RequestBody ChanpinfenleiEntity chanpinfenlei, HttpServletRequest request){
    	chanpinfenlei.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
